...
public class CountryData {
    ...
    public static final String[] countryNames = {"Afghanistan +93", "Albania +355",
            "Algeria +213", "Andorra +376", "Angola +244", "Antarctica672 +", "Argentina +54",
            "Armenia +374", "Aruba +297", "Australia +61", "Austria +43", "Azerbaijan +994",
            "Bahrain +973", "Bangladesh +880", "Belarus +375", "Belgium +32", "Belize +501", "Benin +229",
            "Bhutan +975", "Bolivia +591", "Bosnia And Herzegovina +", "Botswana +",
            ...
            "Sweden +", "Switzerland +", "Syrian Arab Republic +963", "Taiwan +886",
            "Tajikistan +992", "Tanzania +255", "Thailand +66", "Togo +228", "Tokelau +690", "Tonga +676",
            ...
            "Holy See (vatican City State) +39", "Venezuela +58", "Viet Nam +84",
